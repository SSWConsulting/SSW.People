  ...
  return (<AnimatedContainer>
    <header>
      <div className="flex ml-12 mt-4 mb-6">
        ...
        {displayActions ? <div className='action-btn-container'>
          <a href={`https://github.com/SSWConsulting/People/blob/master/${profileId}/${profileId}.md`} className='action-btn-link'>
            <div className='action-btn-label'>Edit</div>
            <GitHubIcon aria-label="logo" className='action-btn-icon'/>
          </a>
          <a href='https://rules.ssw.com.au/make-your-site-easy-to-maintain' className='action-btn-link'>
            <div className='action-btn-label'>Information</div>
