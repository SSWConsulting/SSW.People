...
param errorDocument404Path string = 'people/404/index.html'

var storageAccountName = substring(
  'sapeople${substring(environmentName, 0, 4)}${uniqueString(resourceGroup().id)}',
  0,
  24
)
